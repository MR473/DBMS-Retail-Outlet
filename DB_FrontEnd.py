...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_4 = customtkinter.CTkButton(self.sidebar_frame, command=self.DBRestockQuery, text="Restock check")
    ...
    def UpdateDB(self):
        ...
        self.controller_button = customtkinter.CTkButton(self.my_frame1, command=self.dummy_func, text="Update Database")
    ...
    def CheckDB(self):
        ...
        self.streaming_button = customtkinter.CTkButton(self.my_frame2, command=self.viewtable, text="Check Database")
    ...
    def SearchDB(self):
        ...
        self.communication_button = customtkinter.CTkButton(self.my_frame3, command=self.dummy_func, text="Search Database")
    ...
    def DBRestockQuery(self):
        ...
        self.visualizer_button = customtkinter.CTkButton(self.my_frame4, command=self.dummy_func, text="Apply Query")
    ...
    def viewtable(self):
        ...
        for student in r_set: 
            for j in range(len(student)):
                e = customtkinter.CTkLabel(self.my_frame2, width=10,text=student[j],anchor='w') 
